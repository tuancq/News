    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <!-- Date/Time -->
                <p><span class="glyphicon glyphicon-time"></span> Đăng Lúc: 
                {{$tintuc->created_at}}</p>
                <hr>
                ...
                <div class="media">
                    <a class="pull-left" href="#">
                        <img class="media-object" src="{{asset('../resources/images/account.png')}}" width ="100%" alt="">
                    </a>
