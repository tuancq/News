            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="dashboard"><i class="fa fa-dashboard fa-fw"></i> Quản Trị Website</a>
                        </li>
                        <li>
                       ...
                       <li>
                        ...
                        <li>
                            <a href="admin/user/danhsach"><i class="fa fa-users fa-fw"></i> Tài Khoản<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/user/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/user/them">Thêm Tài Khoản</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
