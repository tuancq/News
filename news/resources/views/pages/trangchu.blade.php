            ...
            <div class="col-md-9">
	            <div class="panel panel-default">            
	            	<div class="panel-heading" style="background-color:#337AB7; color:white;" >
	            		<h2 style="margin-top:0px; margin-bottom:0px;">WEBSITE TIN TỨC</h2>
	            	</div>
					    ...
					    <div class="row-item row">
			                	<h3>
			                		...
			                		@foreach($tl->loaitin as $lt) 	
			                			<small><a href="loaitin/{{$lt->id}}/{{$lt->TenKhongDau}}.html"><i>{{$lt->Ten}}</i>
			                				</a>/
			                			</small>
			                		@endforeach
			                	</h3>
		                	...
		                	<div class="col-md-8 border-right">
			                		<div class="col-md-5">
				                        <a href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">
				                            <img width="100px" class="img-responsive" src="upload/tintuc/{{$tin1['Hinh']}}" alt="">
				                        </a>
				                    </div>
